...
export const metadata: Metadata = {
  title: "Netcurion Technology Insights | Security, Cloud & Engineering",
  description:
    "In-depth guides from Netcurion Technology on cybersecurity best practices, cloud-native patterns, DevOps automation, and modern web engineering.",
  // other metadata
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h1 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight">
                  Netcurion Technology’s blueprint for secure, scalable apps
                </h1>
                ...
                <div>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Building modern products demands a security-first mindset.
                    At Netcurion Technology, we combine secure coding standards,
                    automated testing, and observability to deliver resilient
                    platforms without slowing delivery.
                  </p>
                  ...
                  <p className="mb-8 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Our engineering playbook prioritizes Core Web Vitals, robust
                    CI/CD, and accessibility. We integrate with enterprise auth,
                    SIEM, and headless CMS to ensure compliance and traceability
                    across environments.
                  </p>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    With proactive monitoring and incident response, we minimize
                    downtime and shorten MTTR. The outcome is higher reliability,
                    stronger security posture, and faster iteration.
                  </p>
                  <h3 className="font-xl mb-10 font-bold leading-tight text-black dark:text-white sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight">
                    Digital marketplace for Ui/Ux designers.
                  </h3>
                  <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Netcurion Technology blends DevOps automation with
                    security-by-design—so your teams can ship confidently and
                    your users stay protected.
                  </p>
